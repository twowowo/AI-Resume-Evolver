...
import time
from src.utils.vector_store import hybrid_retrieve, batch_hybrid_retrieve, cross_encoder_rerank, warmup_reranker
...
class RetrieverNode:
    ...
    def __call__(self, state: AgentState):
        ...
        # ── Step 2: 15路批量检索 (v6.2: batch encode + 独立检索) ──
        t_retrieve_start = time.time()
        all_docs: list = []
        batched_results = batch_hybrid_retrieve(
            anchors,
            vector_k=15,
            bm25_k=15,
            fusion_k=8,
